...
RANK_SUIT_VARIANTS = {
    "ace": {
        ...
        "cups": {
            "ru_upr": "Чувство переполняет края: новый эмоциональный опыт готов войти в жизнь ({theme}).",
            "ru_rev": "Чаша пуста или закрыта: впуск чувств блокирован обидой или страхом ({theme}).",
