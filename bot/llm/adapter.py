...
FORMAT_RU = (
    ...
    "Все тексты — живые, связные, без заголовков и списков."
)
FORMAT_EN = (
    ...
    "core_message, symbolic_detail, context_connection), synthesis, practical_focus, "
    "reflection_question, voice_summary, share_summary. "
    "All texts should be natural and flowing, without headings or bullet lists."
)
...
class TarotReadingResult(BaseModel):
    ...
    opening: str = Field(min_length=1, max_length=250)
    card_interpretations: list[CardInterpretation] = Field(min_length=1)
    synthesis: str = Field(min_length=1, max_length=900)
    practical_focus: str = Field(min_length=1, max_length=350)
